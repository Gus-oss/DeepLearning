...
- [Notebooks](Notebooks): En esta carpeta se pondrán los notebooks que realice como notas para el curso.
  ...
  - [Clase3. Redes Neuronales con Keras (DNN)](Notebooks/Clase3.ipynb): Libro de trabajo de la clase 3. Capa de entrada, capa oculta y capa de salida, propagación hacia adelante y hacia atras teniendo capa oculta.
  - [Clase4. Redes Neuornales no supervisadas (CNN)](Notebooks/Clase4.ipynb): Libro de trabajo de la clase 4. Ejemplo de retiro temprano mediante Keras. Optimización de la capa oculta y el numero de neuronas dentro de ella. 
